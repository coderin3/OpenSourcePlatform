...
//1000원 버튼 클릭시 Balance에 1000원 추가되어야 함
function click_btn1() {
    coin = coin + 1000;
    color_change();
    alert("1000원 넣음");
...
//500원 버튼 클릭시 Balance에 1000원 추가되어야 함
function click_btn2() {
    coin = coin + 500;
    color_change();
    alert("500원 넣음");
...
//돼지바(700원) 버튼 클릭시 Balance에 -700원 되고 Choice에 돼지바 나타나야함
function click_icecream1() {
    if(coin >=700){
        ...
        alert("돈이 부족합니다");
        document.getElementById("selection").innerHTML = "돈이 부족합니다"; 
    }
    color_change();
    document.getElementById("current").innerHTML = coin + "원";
}

//월드콘(1000원) 버튼 클릭시 Balance에 -1000원 되고 Choice에 월드콘 나타나야함
...
//누크바(500원) 버튼 클릭시 Balance에 -500원 되고 Choice에 누크바 나타나야함
